...
namespace VVVV.CV.Core
{
    ...
    public class MixerNode<TMixerInstance> : IMixerNode<TMixerInstance> 
        where TMixerInstance : IMixerInstance, new()
    {
        ...
        public MixerNode(IIOFactory factory)
        {
            // Create in and outputs based on properties of the filter instance
            var dummyInstance = new TMixerInstance();
            var filterInstanceType = typeof(TMixerInstance);
