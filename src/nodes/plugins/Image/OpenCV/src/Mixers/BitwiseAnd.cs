...
{
    [MixerInstance("BitwiseAnd", Help = "BitwiseAnd for 2 images", Author = "sebl")]
    public class BitwiseAndInstance : IMixerInstance
    {
        ...
        public override void Process()
        {
            if ( !FNeedsConversion && !FNeedsResize)
            {
                ...
                CvInvoke.cvAnd(FInput1.CvMat, FInput2.CvMat, FOutput.CvMat, IntPtr.Zero);
            ...
            else 
            {
                if (FNeedsConversion)
                {
                    ...
                    if (FNeedsResize)
                    {
                        ...
                        CvInvoke.cvAnd(FInput1.CvMat, resizedInput2.CvMat, FOutput.CvMat, IntPtr.Zero);
                    ...
                    else // only conversion
                    {
                        ...
                        CvInvoke.cvAnd(FInput1.CvMat, convertedInput2.CvMat, FOutput.CvMat, IntPtr.Zero);
